          ...
          {reference ? (
            <div className="flex min-h-[420px] flex-col justify-center">
              ...
              <div className="mt-7 flex flex-col gap-3 sm:flex-row">
                <Link href={`/${safeSlug}`}>
                  <span className="inline-flex justify-center rounded-full bg-zinc-950 px-5 py-2.5 text-xs font-black uppercase tracking-[0.16em] text-white shadow-sm transition hover:bg-zinc-800">
                    Volver al inicio
                  </span>
                </Link>
                {profileWhatsapp ? (
                  <a
                    ...
                    target="_blank"
                    rel="noreferrer"
                    className="inline-flex items-center justify-center gap-2 rounded-full border border-zinc-300 px-5 py-2.5 text-xs font-black uppercase tracking-[0.16em] text-zinc-950 transition"
                  >
                    WhatsApp
            ...
            <form onSubmit={handleSubmit}>
              ...
              <div className="mt-7 flex flex-col gap-3 sm:flex-row">
                <button
                  ...
                  className="inline-flex flex-1 justify-center rounded-full bg-zinc-950 px-5 py-3 text-xs font-black uppercase tracking-[0.16em] text-white shadow-sm transition hover:bg-zinc-800 disabled:cursor-not-allowed disabled:bg-zinc-300"
                >
                ...
                {profileWhatsapp ? (
                  <a
                    ...
                    target="_blank"
                    rel="noreferrer"
                    className="inline-flex items-center justify-center gap-2 rounded-full border border-zinc-300 px-5 py-3 text-xs font-black uppercase tracking-[0.16em] text-zinc-950 transition"
                  >
                    WhatsApp
                    <MessageCircle className="h-4 w-4" />
                  </a>
