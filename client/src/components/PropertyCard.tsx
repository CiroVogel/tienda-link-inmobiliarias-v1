        ...
        <div className="relative aspect-[4/3] overflow-hidden bg-zinc-100">
          ...
          <div className="absolute left-3 top-3 flex flex-wrap gap-2">
            ...
            {property.status !== "available" ? (
              <span className="rounded-full bg-zinc-950 px-3 py-1 text-[11px] font-black uppercase tracking-[0.14em] text-white shadow-sm">
        ...
        <div className="flex items-center justify-between gap-3 border-t border-zinc-100 pt-4">
          ...
          {requestable ? (
            <Link href={`/${slug}/solicitar-visita/${property.id}`}>
              <span className="rounded-full bg-zinc-950 px-3 py-1.5 text-xs font-black uppercase tracking-[0.14em] text-white shadow-sm transition hover:bg-zinc-800">
                Solicitar visita
              </span>
            </Link>
          ) : (
